  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row bg-surface">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="bg-white border-b border-stone-100 sticky top-0 z-40 px-6 lg:px-8 shadow-sm lg:h-[73px]">
          <div className="flex flex-col gap-4 py-4 md:flex-row md:items-center md:justify-between lg:flex-row lg:items-end lg:justify-end lg:py-0">
            <div className="flex justify-center md:justify-start lg:hidden">
              <div className="flex items-center gap-3">
                <span className="material-symbols-outlined text-primary text-2xl">
                  account_balance
                </span>
                <h1 className="font-['Public_Sans'] font-black text-xl text-primary tracking-tight text-center">
                  Congo Tax App
                </h1>
              </div>
            </div>

            <div className="flex items-center justify-between w-full gap-4 lg:w-auto lg:justify-end lg:my-4">
              <div className="flex items-center gap-3">
                <div className="text-left">
                  <p className="text-sm font-black text-on-surface truncate max-w-[140px]">
                    {user?.full_name}
                  </p>
                ...
                <div className="w-11 h-11 rounded-full bg-surface-container-high flex items-center justify-center overflow-hidden border border-primary/10 shadow-sm">
                  <img
        ...
        <nav className="lg:hidden fixed bottom-0 left-0 w-full flex overflow-x-auto justify-center items-center px-2 pb-6 pt-2 bg-white/85 backdrop-blur-xl z-50 rounded-t-xl shadow-[0_-8px_24px_rgba(27,28,28,0.06)] border-t border-stone-200/20">
          <MobileNav user={user} />
        </nav>
      </div>
    </div>
  ...
  return (
    ...
    >
      {({ isActive }) => (
        <>
          <div
            className={`p-1.5 rounded-lg transition-colors ${isActive ? "bg-primary/10" : ""}`}
          >
